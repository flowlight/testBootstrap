...
<div id="envoyerAmi" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="<?php echo _("Envoyer un lien vers ce site à un ami"); ?>" aria-hidden="true">
	<?php
	if (!empty($alert))
	{
