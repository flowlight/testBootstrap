				...
				<div id="collapseOne" class="accordion-body collapse in">
					<div class="accordion-inner">
						<div class="row-fluid">
							...
							<div class="span9">
								<p>Sartrouville se situe à 15 km à l’ouest de Paris et à 20 mn du centre de Paris, à proximité d’importants pôles d’emplois de la région parisienne. : Paris, La Défense, Cergy Pontoise.</p>
								<p>C’est la deuxième ville des Yvelines par sa population qui atteint 52 000 habitants.</p>
							</div>
						</div>

						<div class="row-fluid">
							<div class="span9">
								<p>Riche de son passé historique, fluvial et viticole, elle se développe avec de nombreux projets architecturaux et des équipements sportifs. Son église St Martin a fêté son millénaire en 2009.</p>
								<p>Notre ville se situe à proximité de nombreux sites touristiques tels que Versailles, St Germain en Laye, Maisons Laffitte, Rueil Malmaison, tant chargés d’histoire, ainsi que des sites d’activité tels que Poissy, Cergy Pontoise et le quartier d’affaires international de La Défense.</p>
								<i>Pour en savoir plus : <a href="http://www.sartrouville.fr" target="_blank">www.sartrouville.fr</a></i>
							</div>
							<div class="span3">
				...
				<div id="collapseTwo" class="accordion-body collapse">
					<div class="accordion-inner">
						<div class="row-fluid">
							...
							<div class="span9">
								<p>La région ouest de Paris présente une géographie diversifiée et riche en paysages changeants.</p>
								<p>La Seine s’y promène avec nonchalance et côtoie villes, forêts, cultures maraîchères, champs de course au gré de ses méandres.</p>
							</div>
						</div>

						<div class="row-fluid">
							<div class="span9">
								<p>Nous pouvons vous fournir des vélos pour découvrir les alentours, pour 5 €</p>
							</div>
							<div class="span3">
				...
				<div id="collapse5" class="accordion-body collapse">
					<div class="accordion-inner">
						...
						<div class="row-fluid">
							...
							<div class="span3">
								<p><img src="img/saint-martin.jpg" alt="Mairie de Sartrouville" style="height:160px;"></p>
							</div>
						</div>
					</div>
				</div>
